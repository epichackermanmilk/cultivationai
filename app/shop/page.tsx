...
const FAQ = [
  { q: 'What are tokens?', a: 'Tokens are the currency used to chat with novels on NovelCodex. Each message costs roughly 10 tokens depending on the length and complexity of the conversation.' },
